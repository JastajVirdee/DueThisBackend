...
public class TestAccountController
{
	...
	public void testCreateInvalidEmail()
	{
		...
		try
		{
			ac.createAccount(username, password, invalidEmail, experienced, avail, avail, avail, avail, avail, avail,
					avail);
		} catch (InvalidInputException e)
		{
			error = e.getMessage();
	...
	public void testCreateNegativeAvailability()
	{
		...
		try
		{
			ac.createAccount(username, password, email, experienced, negAvail, negAvail, negAvail, negAvail, negAvail,
					negAvail, negAvail);
		} catch (InvalidInputException e)
		{
			error = e.getMessage();
	...
	public void testCreateOver24Availability()
	{
		...
		try
		{
			ac.createAccount(username, password, email, experienced, over24Avail, over24Avail, over24Avail, over24Avail,
					over24Avail, over24Avail, over24Avail);
		} catch (InvalidInputException e)
		{
			error = e.getMessage();
		}
	...
	public void testDeleteAccountValidInfo()
	{
		...
		try
		{
			ac.createAccount("Person", "1234", "email@email.com", experienced, avail, avail, avail, avail, avail, avail,
					avail);
			ac.createAccount("User", "pass", "email@gmail.com", experienced, avail, avail, avail, avail, avail, avail,
					avail);
		} catch (InvalidInputException e)
		{
			fail();
